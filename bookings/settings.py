...
# Allow Render hosts
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=['localhost', '127.0.0.1', '.onrender.com', 'neo-scape-properties-ltd-nine.vercel.app'])
...
CSRF_TRUSTED_ORIGINS = env.list('CSRF_TRUSTED_ORIGINS', default=[
    'https://neo-scape-properties-ltd-nine.vercel.app',
    'https://neoscapeproperties.netlify.app',
    'http://localhost:5173',
    'http://127.0.0.1:5173',
])
